...
mooWP acts as a bridge between mooSocial platform and Wordpress to turn your WordPress Site Into a Social Network. It allows you to turn your one-time visitors into loyal, long-term users by providing them a place to sign up, connect with each other, post messages, and more
...
Quick support: we provide the best customer support through many support channels like ticket, skype, community and online chat. For each client, we have dedicated technical support staff to handle any questions from them to help you create a successful community. Please read our review here (link to https://www.capterra.com/p/139254/mooSocial/ )
...
Please visit our [demo site](https://wordpress.moosocial.com/), login as username: demo, password: 123456 to take a test drive. The demo includes all social features and plugins come with a basic package. You can purchase the premium plugins at  [mooSocial.com](https://moosocial.com/product-category/addons/plugins/)
  
== Getting Started ==

To integrate mooSocial to add the social network features on your Wordpress site, follow the below steps:

* Purchase mooWP here [mooWP](https://moosocial.com/moowp-social-networking-plugin-for-wordpress/)
* Download installation packages (3 packages) at client area
...
* Contact us for Free configuration service to make the two platforms seamlessly integrated. Or you can configure by yourself  by following the instructions here [Configuration]( https://moosocial.com/knowledge-base/category/social-networking-plugin-for-wordpress/)
...
See our [mooWP Pricing Page](https://moosocial.com/moowp-social-networking-plugin-for-wordpress/).
...
= What is system requirements =
 ...
 Click here for the installation guide and requirement for hosting (here link to https://moosocial.com/knowledge-base/install-moosocial/ ) 
...
= Do all plugins from mooSocial work with mooWP? =

Yes, all plugins are compatible with with mooSocial plugin

= Will mooWP work with my WordPress theme? = 

No, but we do provide FREE Installation & Configuration Service to help you to make the community look and feel the same as the theme that you’re using. See more details at the “Installation & Configuration Service” section.

= Does mooWP support multi-language? =
Yes but only for the community site. You have to take care the language separate at your own wordpress site

= How does the license work? =

It’s per domain, if you need to buy for multiple domains, please contact us for bulk purchase pricing.

= mooWP works with any wp plugins? =

Yes, it works with a properly built WordPress plugin.

= How do I report a bug/problem and get technical support? =

Can open support ticket here: [Open ticke](https://clients.moosocial.com/tickets/create/). For urgent issues, please add my skype id moosocial.support or whatsapp id +84913638785. Our time zone is GMT +7. Business hours are Mon - Fri (8am -> 17PM). During business hours, we reply to the requests in less than 24 hours,but it can take us up to 48 hours to get back to you during the weekend or holidays. 

 == Upgrade Notice == 

We will send an announcement whenever a new version is released. You can download at the client area https://moosocial.com/my-account/ and follow the instructions here https://moosocial.com/knowledge-base/upgrading-moowp-solution/ to upgrade.
